                ...
                <div className="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex">
                    <div className="relative bg-white w-1/3 max-w-xl m-auto rounded-md shadow-lg">
                        ...
                        <div className="px-4 py-4 flex justify-end">
                            <button onClick={handleOnApply} disabled={isApplyDisabled}
                                className={`rounded font-semibold text-2xl px-4 ${isApplyDisabled ? 'text-gray-500' : 'text-transparent bg-gradient-to-r from-yellow-400 to-pink-700 bg-clip-text'}`}>
                                Apply
                            </button>
